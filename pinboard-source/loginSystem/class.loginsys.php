...
class LoginSystem {
	...
	/* Start Config */
 	...
 	private $company      = "http://subinsb.com"; // Company for name for including in emails
	...
	var $blockBruteForce	= true; // Deny login for $LS->bfTime seconds after incorrect login tries of 5
		...
		/* Extra Settings*/
			...
			private $loginPage    	= "/php/loginSystem/login.php"; // The login page. ex : /login.php or /accounts/login.php
			private $homePage     	= "/php/loginSystem/home.php"; // The home page. The main page for logged in users. Redirects to here when logs in
